...
## OpenSCAD / FDM 3D Printing

Engineering knowledge for designing and printing functional parts with OpenSCAD and FDM printers (Bambu Lab, Prusa, etc.).

* [OpenSCAD Engineering KB](openscad/index.md) — entry point; covers materials, mechanics, and CSG algorithms.
